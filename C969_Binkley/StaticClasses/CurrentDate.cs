...
namespace C969_Binkley
{
    public static class CurrentDate
    {
        ...
        // This method should get all the appointments of the current month and put them in the appointmentsByMonth BindingList
        ...
        // DataGridView -> Void
        // This method sets the input DataGridView to the appointmentsByMonth BindingList
        ...
        // Void -> BindingList<Appointment>
        // This method should get all the appointments of the current week and put them in the appointmentsByWeek BindingList
        ...
        // DataGridView -> Void
        // This method sets the input DataGridView to the appointmentsByWeek BindingList
        ...
        // Int -> Void
        // This method takes the current DateTime and adds a integer to it(subtracts if negative number is input) to change the month
        ...
        // Int -> Void
        // This method takes the current DateTime and adds a integer to it(subtracts if negative number is input) to change the week
